...
import { restoreScrollPosition, saveScrollPosition } from "../Scrolling Functions/scrollstate.js";
import { changeClassList } from "./ChangeClasslist.js";
import { localfavList, localfavListDelete } from "../localFavlist/localfavlist.js";



export function ShowDetails(label){
    ...
    ShowDet.addEventListener('click',(event)=>{
        ...
        const recipe = SearchQue()[parent.index].recipe;
        ...
        if(favoriteAdd) favoriteAdd.addEventListener('click',()=>{
